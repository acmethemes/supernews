...
if ( ! class_exists( 'supernews_ad_widget' ) ) :
    ...
    class supernews_ad_widget extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'supernews_ad_title' ) ); ?>"><?php esc_html_e( 'Title:', 'supernews' ); ?></label>
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'supernews_ad_title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'supernews_ad_title' ) ); ?>" type="text" value="<?php echo esc_attr( $supernews_ad_title ); ?>" />
            </p>
            <h4 class="accordion-toggle"><?php esc_html_e( 'Advertisement Image', 'supernews' ); ?></h4>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'supernews_ad_image' ) ); ?>">
                ...
                <input type="text" class="widefat" name="<?php echo esc_attr( $this->get_field_name( 'supernews_ad_image' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'supernews_ad_image' ) ); ?>" value="<?php echo esc_url( $supernews_ad_image ); ?>" />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'supernews_ad_img_alt' ) ); ?>"><?php esc_html_e( 'Alt Text:', 'supernews' ); ?></label>
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'supernews_ad_img_alt' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'supernews_ad_img_alt' ) ); ?>" type="text" value="<?php echo esc_attr( $supernews_ad_img_alt ); ?>" />
            </p>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'supernews_ad_link' ) ); ?>"><?php esc_html_e( 'Link URL:', 'supernews' ); ?></label>
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'supernews_ad_link' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'supernews_ad_link' ) ); ?>" type="text" value="<?php echo esc_attr( $supernews_ad_link ); ?>" />
            </p>
            <p>
                <input id="<?php echo esc_attr( $this->get_field_id( 'supernews_ad_new_window' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'supernews_ad_new_window' ) ); ?>" type="checkbox" <?php checked( 1 == $supernews_ad_new_window ? $instance['supernews_ad_new_window'] : 0); ?> />
                <label for="<?php echo esc_attr( $this->get_field_id( 'supernews_ad_new_window' ) ); ?>"><?php esc_html_e( 'Open in new window', 'supernews' ); ?></label>
            </p>
            <hr />
            <?php
        }
