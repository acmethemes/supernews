...
if ( ! class_exists( 'Supernews_posts_col' ) ) {
    ...
    class Supernews_posts_col extends WP_Widget {
        ...
        public function form( $instance ) {
           ...
           ?>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'supernews_cat_title' ) ); ?>"><?php _e( 'Title:', 'supernews' ); ?></label>
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'supernews_cat_title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'supernews_cat_title' ) ); ?>" type="text" value="<?php echo $supernews_col_posts_title; ?>" />
            </p>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'supernews_cat' ) ); ?>"><?php esc_html_e('Select Category', 'supernews'); ?></label>
                <?php
            ...
            <p>
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'supernews_enable_posts_featured' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'supernews_enable_posts_featured' ) ); ?>" type="checkbox" <?php checked( 1, esc_attr( $supernews_enable_posts_featured ), 1 ); ?>/>
                <label for="<?php echo esc_attr( $this->get_field_id( 'supernews_enable_posts_featured' ) ); ?>"><?php esc_html_e( 'Enable Posts Featured' ,'supernews'); ?></label>
                <br />
            </p>
            <p>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'supernews_post_col_first_featured_image_layout' ) ); ?>">
			        <?php _e( 'First Featured Post Image', 'supernews' ); ?>
                    <br />
                    <small><?php _e( 'Enable First Post Featured to work this layout', 'supernews' ); ?></small>
                </label>
                <select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'supernews_post_col_first_featured_image_layout' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'supernews_post_col_first_featured_image_layout' ) ); ?>">
			        <?php
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'supernews_post_col_normal_image_layout' ) ); ?>">
			        <?php _e( 'Normal Featured Post Image', 'supernews' ); ?>
                    <br />
                    <small><?php _e( 'Enable First Post Featured to work this layout', 'supernews' ); ?></small>
                </label>
                <select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'supernews_post_col_normal_image_layout' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'supernews_post_col_normal_image_layout' ) ); ?>">
			        <?php
			        foreach( $choices as $key => $supernews_column_array ){
